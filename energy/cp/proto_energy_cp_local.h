...
void cp_rho_calc_dvr_all_space(CPSCR *,CELL *,double *,int ,int ,
                               double *,double *,double *,
                               int ,int ,int , int, int, int,
                               COMMUNICATE *, PARA_FFT_PKG3D *);

void calc_hartree_dvr_pbc(CPOPTS *,CPEWALD *,double *,double *,
                          double *,double *, double *,double *,
                          double *, double *,double *,
                          double *, double *,int , int ,
                          EWALD *,CELL *,COMMUNICATE *,
                          int ,int ,int , int ,int ,int *,int *,
                          PARA_FFT_PKG3D *);

void eext_loc_real_space_dvr(CLATOMS_POS *,ATOMMAPS *,PSEUDO *,EWD_SCR *,CELL *,
                            COMMUNICATE *, double *, double *,double *,int ,int ,
                            double *,PARA_FFT_PKG3D *);


void eext_loc_recip_space_dvr(CLATOMS_INFO *,CLATOMS_POS *, CELL *,EWALD *,
                              CPEWALD *, CPSCR *,PSEUDO *,EWD_SCR *,
                              ATOMMAPS *, double *,double *,
                              double *,double *, COMMUNICATE *,FOR_SCR *,
                              int ,int ,int );


void vps_atm_list_dvr(PSEUDO *,CELL *, PARA_FFT_PKG3D *, CPSCR_NONLOC *,
                      ATOMMAPS *,int , int );


void get_vpsnow_dvr(int ,int , double , double ,double ,double *,double *,
                    double *,double *,double *);

void get_dvpsnow_dvr(int ,int ,double , double ,double ,double *,double *,
                     double *,double *,double *);

void control_eext_nonloc_dvr(ATOMMAPS *,PSEUDO * , CLATOMS_POS *, CPSCR_NONLOC *,
                     CPSCR_WAVE *, EWD_SCR *, CPOPTS *, CPCOEFFS_INFO *,
                     CPCOEFFS_POS_DVR *,CELL *, COMMUNICATE *,
                     PARA_FFT_PKG3D *, int , double *,int , double **, double );

void eext_nonloc_dvr_mm(ATOMMAPS *,PSEUDO *,CLATOMS_POS *, CPSCR_NONLOC *,
                        CPSCR_WAVE *, EWD_SCR *, CELL *, PARA_FFT_PKG3D * ,
                        COMMUNICATE *, double *, double *,
                        int , int , int , int , double *, double *, double *,
                        double *, double *, double *, double *, double *, double *);

void control_exc_real_space_dvr (CELL *,EWALD *,PSEUDO *,CPOPTS *,
                            CPCOEFFS_INFO *,CPSCR_WAVE *,
                            PARA_FFT_PKG3D *, CPCOEFFS_POS_DVR *,
                            COMMUNICATE *, CPSCR *, DVR_MATRIX *,
                            double *, double *, CP_COMM_STATE_PKG *,
                            CP_COMM_STATE_PKG *, double *, double *);


void  excpot_pz_lda_dvr(double *,double *,double *,
                        double *,double *,double ,
                        int ,int ,int ,int ,int , int , double);


void  grad_dens_dvr_par(double *,DVR_MATRIX *,CPSCR_GRHO *,CPCOEFFS_INFO *,
                      double *, CP_COMM_STATE_PKG *, double *,double *,
                      COMMUNICATE *,PARA_FFT_PKG3D *);



void  grad_corr_lda_dvr_par(CPSCR *, CPCOEFFS_INFO *,double *,double *,
                            EWALD *, CELL *,double *,double *,
                            double ,CPOPTS *,double ,double *,double *,
                            DVR_MATRIX *,COMMUNICATE *,CP_COMM_STATE_PKG *,
                            PARA_FFT_PKG3D *,int );


void calc_ekin_dvr_par(double *,double *,DVR_MATRIX *, 
                       CPCOEFFS_INFO *,int ,  double *,double *,
                       double *,double , COMMUNICATE *, PARA_FFT_PKG3D *);


void  b3_lyp_gcc(double ,double ,double *,double *,double *);

void calc_hartree_dvr_clus (CPCOEFFS_INFO *, CPSCR_WAVE *,
                 CP_DVR_CLUS *, double *,  double *, double *,
                 double *,double *, double *, int , int , COMMUNICATE *);

void get_hartree_pot_clus(double *, double *, int ,
                    CPCOEFFS_INFO *, CPSCR_WAVE *, CP_DVR_CLUS *);
