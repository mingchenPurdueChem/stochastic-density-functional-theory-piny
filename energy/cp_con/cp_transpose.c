...
/*======================================================================*/
  ...
  if(np_states>1){
    for(ip=1;ip<=pi_beads_proc;ip++){
      ...
      if(iopt_cp_dvr==1){
        cp_transpose_fwd_dvr((cp->cpcoeffs_pos_dvr[ip].dvrc_up),
                             &(cp->cpcoeffs_pos_dvr[ip].icoef_form_up),
                             cp->cpscr.cpscr_wave.cre_up,
                             &(cp->cp_comm_state_pkg_dvr_up),
                             cp->cp_para_fft_pkg3d_sm.nkf1,
                             cp->cp_para_fft_pkg3d_sm.nkf2,
                             cp->cp_para_fft_pkg3d_sm.nkf3);

        if(cp_lsda==1 && nstate_dn != 0){
          cp_transpose_fwd_dvr((cp->cpcoeffs_pos_dvr[ip].dvrc_dn),
                               &(cp->cpcoeffs_pos_dvr[ip].icoef_form_dn),
                               cp->cpscr.cpscr_wave.cre_dn,
    ...
    if(iopt>=2){
      for(ip=1;ip<=pi_beads_proc;ip++){
        ...
        if(iopt_cp_dvr==1){
          cp_transpose_fwd_dvr((cp->cpcoeffs_pos_dvr[ip].dvrvc_up),
                               &(cp->cpcoeffs_pos_dvr[ip].ivcoef_form_up),
                               cp->cpscr.cpscr_wave.cre_up,
                               &(cp->cp_comm_state_pkg_dvr_up),
                               cp->cp_para_fft_pkg3d_sm.nkf1,
                               cp->cp_para_fft_pkg3d_sm.nkf2,
          ...
          if(cp_lsda==1 && nstate_dn != 0){
            cp_transpose_fwd_dvr((cp->cpcoeffs_pos_dvr[ip].dvrvc_dn),
                                 &(cp->cpcoeffs_pos_dvr[ip].ivcoef_form_dn),
                                 cp->cpscr.cpscr_wave.cre_dn,
                                 &(cp->cp_comm_state_pkg_dvr_dn),
                                 cp->cp_para_fft_pkg3d_sm.nkf1,
                                 cp->cp_para_fft_pkg3d_sm.nkf2,
    ...
    if(iopt==3 && cp->cptherm_info.massiv_flag == 1){
      ...
      if(iopt_cp_dvr==1){
        printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
        printf("NO CPTHERM for DVR yet (control coef_transpose_fwd\n");
        printf("Please contact technical support \n");
        printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
        fflush(stdout);
        exit(1);
      }
...
/*======================================================================*/
  ...
  if(np_states>1){
    for(ip=1;ip<=pi_beads_proc;ip++){
      ...
      if(iopt_cp_dvr==1){
        cp_transpose_bck_dvr((cp->cpcoeffs_pos_dvr[ip].dvrc_up),
                             &(cp->cpcoeffs_pos_dvr[ip].icoef_form_up),
                             cp->cpscr.cpscr_wave.cre_up,
                             &(cp->cp_comm_state_pkg_dvr_up),
                             cp->cp_para_fft_pkg3d_sm.nkf1,
                             ...
                             cp->cp_para_fft_pkg3d_sm.nkf3);
        if(cp_lsda==1){
          cp_transpose_bck_dvr((cp->cpcoeffs_pos_dvr[ip].dvrc_dn),
                               &(cp->cpcoeffs_pos_dvr[ip].icoef_form_dn),
                               cp->cpscr.cpscr_wave.cre_up,
                               &(cp->cp_comm_state_pkg_dvr_dn),
                               cp->cp_para_fft_pkg3d_sm.nkf1,
    ...
    if(iopt>=2){
      for(ip=1;ip<=pi_beads_proc;ip++){
        ...
        if(iopt_cp_dvr==1){
          cp_transpose_bck_dvr((cp->cpcoeffs_pos_dvr[ip].dvrvc_up),
                               &(cp->cpcoeffs_pos_dvr[ip].ivcoef_form_up),
                               cp->cpscr.cpscr_wave.cre_up,
                               &(cp->cp_comm_state_pkg_dvr_up),
                               cp->cp_para_fft_pkg3d_sm.nkf1,
                               ...
                               cp->cp_para_fft_pkg3d_sm.nkf3);
          if(cp_lsda==1){
            cp_transpose_bck_dvr((cp->cpcoeffs_pos_dvr[ip].dvrvc_dn),
                                 &(cp->cpcoeffs_pos_dvr[ip].ivcoef_form_dn),
                                 cp->cpscr.cpscr_wave.cre_up,
                                 &(cp->cp_comm_state_pkg_dvr_dn),
                                 cp->cp_para_fft_pkg3d_sm.nkf1,
    ...
    if(iopt==3 && cp->cptherm_info.massiv_flag == 1){
      ...
      if(iopt_cp_dvr==1){
        printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
        printf("NO CPTHERM for DVR yet (control coef_transpose_bck\n");
        printf("Please contact technical support \n");
        printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
        fflush(stdout);
        exit(1);
