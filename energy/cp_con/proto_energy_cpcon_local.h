...
void cp_shake_dvr(double *,int , int ,
                  double *,int ,double *,
                  int , double ,double ,
                  CPSCR_OVMAT *,int *,double *,
                  double *,int ,int *,
...
void cp_rattle_dvr(double *,int , int ,
                   double *,int ,CPSCR_OVMAT *,
                   int *,double *,
                   CP_COMM_STATE_PKG *,int ,double );
...
void control_cp_gram_schmidt_dvr(double *,int , double *, double *, double *,
                                 int *, double , CP_COMM_STATE_PKG *);
...
void cp_gram_schmidt_par_dvr(double *,int ,double *,int *, double *, double *,
...
void cp_normalize_dvr(double *,int , double *, int *, double *,double *,
                      CP_COMM_STATE_PKG *);
...
void cp_add_ksmat_force_dvr(double *,int ,int , double *,int ,int ,
...
void cp_rotate_gen_nonortho_dvr(double *,int ,int *,double *,
                                int *,double *,CP_COMM_STATE_PKG *);


void cp_rotate_coef_ortho(double *,double *, int ,int *,double *,double *,
                          double *, double *,double *,double *,int *,
                          double *,double *, CPSCR_OVMAT *,
                          CP_COMM_STATE_PKG *);

void cp_rotate_coef_ortho_dvr(double *, int ,int *,
                              double *,double *,
                              double *, double *, double *, int *,
                              double *,double *, double ,
                              CPSCR_OVMAT *, CP_COMM_STATE_PKG *);
...
void cp_construct_orth_rotmat_dvr(double *, int ,int , double *,double *,
                                  double *, double *, int *,
                                  double *,double *, double , CPSCR_OVMAT *,
                                  CP_COMM_STATE_PKG *);
...
void cp_rotate_vector_dvr(double *, int ,
                          double *,int *,double *,
                          CP_COMM_STATE_PKG *);
...
void cp_rotation_prim_dvr(double *,int , double *,int , double *,
                          double ,double ,int *,CP_COMM_STATE_PKG *);
...
void cp_rotate_prim_par_dvr(double *,int ,
                            double *,int ,
                            double *,double ,double,
                            CP_COMM_STATE_PKG *);
...
void rotate_occ_shuffle_dvr(double *,int , double *,double *, double *,double *,
                            int *,double , CP_COMM_STATE_PKG *);
...
void cp_ovlap_mat_same_dvr(double *,int , double *,double *,double ,
                           double ,int *, CP_COMM_STATE_PKG *);

void cp_par_ovlap_same(double *,int ,
                       double *,double ,
                       CP_COMM_STATE_PKG *);

void cp_par_ovlap_same_dvr(double *,int , double *,double ,double ,
                           CP_COMM_STATE_PKG *);
...
void cp_ovlap_mat_diff_dvr(double *,int , double *,int ,
                           double *,double *, double ,double ,int *,
                           CP_COMM_STATE_PKG *);
...
void cp_par_ovlap_diff_dvr(double *,int , double *,int , 
                           double *,double ,double ,
                           CP_COMM_STATE_PKG *);
...
void cp_transpose_fwd_dvr(double *,int *,double *,
                          CP_COMM_STATE_PKG *,int ,int ,int );

void cp_transpose_bck(double *,double *,int *,
                      double *,double *,
                      CP_COMM_STATE_PKG *);

void cp_transpose_bck_dvr(double *,int *,double *,
                          CP_COMM_STATE_PKG *,int ,int ,int );
...
void cp_transpose_fwd_prim_dvr(double *,int *,double *,
                               int ,int ,int ,
                               int , int , int, int , int,
                               int ,int ,int ,
                               int ,int ,MPI_Comm );
...
void cp_transpose_bck_prim_dvr(double *,int *,double *,
                               int ,int ,int ,
                               int ,int , int, int , int,
                               int ,int ,int ,
                               int ,int ,MPI_Comm );
