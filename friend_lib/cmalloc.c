...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
/* cmall_itens3: Careful allocation of a 3rd rank tensor of integers        */
/*==========================================================================*/

int ***cmall_itens3(long nrl,long nrh,long ncl,long nch,long ndl,long ndh)
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
/* cfree_itens3: Careful free of a 3rd rank tensor of integers              */
/*==========================================================================*/
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
/* cmall_ivector: Careful allocation of a vector of integers                */
/*==========================================================================*/

int *cmall_ivector(long nrl, long nrh)
{
 /* allocate a int vector with subscript range v[nrl...nrh] */
 long i,nrow=nrh-nrl+1;
 int *v;

 if(nrow <= 0) return(int *)NULL;
 v=(int *) malloc((size_t)((nrow+NR_END)*sizeof(int)));
 if(!v)
   {
    printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
    printf("allocation failure of row pointers cmall_dvector\n");
    printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
    fflush(stdout);
    Finalize(); exit(1);
   }
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
/* cfree_ivector: Careful free of a vector of integers                      */
/*==========================================================================*/


void cfree_ivector(int *v, long nrl,long nrh)
{
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
/* cmall_zomp3: Careful malloc a rank 3 tensor of type  zomplex              */
/*==========================================================================*/

zomplex ***cmall_zomp3(long nrl, long nrh, long ncl, long nch, long ndl, long ndh){

  long i,j, nrow=nrh-nrl+1,ncol=nch-ncl+1,ndep=ndh-ndl+1;
  zomplex ***m;

  if(nrow <= 0 || ncol <= 0 || ndep <= 0) return (zomplex ***)NULL;

  m=(zomplex ***) malloc((size_t)((nrow+NR_END)*sizeof(zomplex**)));
  if(!m)
    {
     printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
     printf("allocation failure of row pointers cmall_zomp3\n");
     printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
     fflush(stdout);
     exit(1);
    }
...
/* allocate rows and set pointers to them */
  m[nrl]=(zomplex **) malloc((size_t)((nrow*ncol+NR_END)*sizeof(zomplex*)));
  if(!m[nrl])
    {
      printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
      printf("allocation failure of rows in cmall_zomp3\n");
      printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
      fflush(stdout);
      exit(1);
    }
...
/* allocate columns and set pointers to them */
  m[nrl][ncl]=(zomplex *) malloc((size_t)((nrow*ncol*ndep+NR_END)
                                         *sizeof(zomplex)));
  if(!m[nrl][ncl])
    {
      printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
      printf("allocation failure of columns in cmall_zomp3\n");
      printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
      fflush(stdout);
      exit(1);
    }
...
/* calculate address of each array element */
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
/* cmall_zomp2: Careful malloc a matrix of type zomplex                        */
/*==========================================================================*/
zomplex **cmall_zomp2(long nrl, long nrh, long ncl, long nch)
/* allocate a zomplex matrix with subscript range m[nrl...nrh][ncl...nch] */
{
  long i, nrow=nrh-nrl+1,ncol=nch-ncl+1;
  zomplex **m;

  if(nrow <= 0 || ncol <= 0) return (zomplex **)NULL;
/* allocate pointers to rows */
  m=(zomplex **) malloc((size_t)((nrow+NR_END)*sizeof(zomplex*)));
  if(!m)
    {
     printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
     printf("allocation failure of row pointers in cmall_zomp2\n");
     printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
     fflush(stdout);
     exit(1);
    }
...
/* allocate rows and set pointers to them */
  ...
  if(!m[nrl])
    {
      printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
      printf("allocation failure of rows in cmall_zomp2\n");
      printf("@@@@@@@@@@@@@@@@@@@@_ERROR_@@@@@@@@@@@@@@@@@@@@\n");
      fflush(stdout);
      exit(1);
    }
...
void cfree_zomp3(zomplex ***m,long nrl,long nrh,long ncl,long nch,
                             long ndl,long ndh)
{
  free((char *) (m[nrl][ncl]+ndl-NR_END));
  free((char *) (m[nrl]+ncl-NR_END));
...
void cfree_zomp2(zomplex **m,long nrl, long nrh, long ncl, long nch)
{
  free((char *) (m[nrl]+ncl-NR_END));
  free((char *) (m+nrl-NR_END));
}/* end routine */
