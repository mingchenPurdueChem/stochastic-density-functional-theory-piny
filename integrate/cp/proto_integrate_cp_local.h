...
/* half step cp integrators */
 ...
 void int_0_to_dt2_cp_dvr(CLASS *,BONDED *, GENERAL_DATA *,CP *);

 void int_dt2_to_dt_cp(CLASS *,BONDED *,GENERAL_DATA *,CP *);

 void int_dt2_to_dt_cp_dvr(CLASS *,BONDED *,GENERAL_DATA *,CP *);
...
void get_cpke_dvr(CPCOEFFS_INFO *,CPCOEFFS_POS_DVR *, STAT_AVG *, int ,int);
