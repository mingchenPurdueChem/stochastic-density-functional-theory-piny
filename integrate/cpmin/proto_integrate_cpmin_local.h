...
double diag_ovlap_dvr(int ,double *,double *,int );
...
void cp_shuffle_prim_dvr(double *,int ,double *,int *,
                         double *,double *,double *, int ,
                         VEL_SAMP_CP *,CP_COMM_STATE_PKG *);
...
void get_precon_force_dvr(double *,double *,int ,DVR_MATRIX *,
                      CPCOEFFS_INFO *,CPSCR_WAVE *, int , int );
