...
/* II) Fill the dictionary with words */
  ...
  strcpy((*inter_dict)[3].error_mes,"lennard-jones,williams,aziz-chen,grimme,null");
  ...
  /*-----------------------------------------------------------------------*/ 
  /* 17) /RvdW{} */
  strcpy((*inter_dict)[17].keyword,"RvdW");
  strcpy((*inter_dict)[17].keyarg,"0.0");
  strcpy((*inter_dict)[17].error_mes,"a number 0");
  /*-----------------------------------------------------------------------*/ 
  /* 18) /s6{} */
  strcpy((*inter_dict)[18].keyword,"s6");
  strcpy((*inter_dict)[18].keyarg,"0.0");
  strcpy((*inter_dict)[18].error_mes,"a number 0");
  /*-----------------------------------------------------------------------*/ 
}  /*end routine*/
/*==========================================================================*/
