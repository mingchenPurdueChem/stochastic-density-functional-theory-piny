...
/* II) Fill the dictionary with words */
  ...
  /*-----------------------------------------------------------------------*/
  /*--------------------------------------------------------------------*/
  /*  24) ~pseudoatom_dafed_def[] */
  strcpy((*fun_dict)[24].keyword,"pseudoatom_dafed_def");
  strcpy((*fun_dict)[24].keyarg,"");
  strcpy((*fun_dict)[24].error_mes,"");
  (*fun_dict)[24].key_type=2;
  /*-----------------------------------------------------------------------*/
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
/*  set_dafed_dict:set up the ~pseudoatom_dafed_def[] dictionary            */
/*==========================================================================*/
void set_dafed_dict(DICT_WORD *dafed_dict[],int *num_dafed_dict,int ifirst)
{
  int i;

  if(ifirst==1){
    *num_dafed_dict = 10;
    *dafed_dict = (DICT_WORD*)cmalloc(*num_dafed_dict*sizeof(DICT_WORD))-1;
  }
    /*========================================================================*/
  /* I) Assign the users set flags 0 */
  for(i=1;i<=*num_dafed_dict;i++){(*dafed_dict)[i].iuset = 0;}
  for(i=1;i<=*num_dafed_dict;i++){(*dafed_dict)[i].key_type = 0;}
  /*========================================================================*/
  /*-----------------------------------------------------------------------*/
  /* 1\atom_index{} */
  strcpy((*dafed_dict)[1].keyword,"atom_index");
  strcpy((*dafed_dict)[1].keyarg,"");
  strcpy((*dafed_dict)[1].error_mes,"Not a integer");
  (*dafed_dict)[1].key_type=1;
  /*-----------------------------------------------------------------------*/
  /* 2)\name{} */
  strcpy((*dafed_dict)[2].keyword,"name");
  strcpy((*dafed_dict)[2].keyarg,"");
  strcpy((*dafed_dict)[2].error_mes,"This is not a CV's name.");
  (*dafed_dict)[2].key_type=1;
  /*-----------------------------------------------------------------------*/
  /* 3)\atom_list{} */
  strcpy((*dafed_dict)[3].keyword,"atom_list");
  strcpy((*dafed_dict)[3].keyarg,"");
  strcpy((*dafed_dict)[3].error_mes,"put it like this:1,2,3,4");
  (*dafed_dict)[3].key_type=1;
  /*-----------------------------------------------------------------------*/
  /* 4)\mass{} */
  strcpy((*dafed_dict)[4].keyword,"mass");
  strcpy((*dafed_dict)[4].keyarg,"600.0");
  strcpy((*dafed_dict)[4].error_mes,"a real number");
  (*dafed_dict)[4].key_type=1;
  /*-----------------------------------------------------------------------*/
  /* 5)\temperature{} */
  strcpy((*dafed_dict)[5].keyword,"temperature");
  strcpy((*dafed_dict)[5].keyarg,"300.0");
  strcpy((*dafed_dict)[5].error_mes,"a real number");
  (*dafed_dict)[5].key_type=1;
  /*-----------------------------------------------------------------------*/
  /* 6)\force_const{} */
  strcpy((*dafed_dict)[6].keyword,"force_const");
  strcpy((*dafed_dict)[6].keyarg,"1000.0");
  strcpy((*dafed_dict)[6].error_mes,"a real number");
  (*dafed_dict)[6].key_type=1;
  /*-----------------------------------------------------------------------*/
  /* 7)\cv_min{} */
  strcpy((*dafed_dict)[7].keyword,"cv_min");
  strcpy((*dafed_dict)[7].keyarg,"0.0");
  strcpy((*dafed_dict)[7].error_mes,"a real number,angle in degree");
  (*dafed_dict)[7].key_type = 1;    

  /*-----------------------------------------------------------------------*/
  /* 8)\cv_max{} */
  strcpy((*dafed_dict)[8].keyword,"cv_max");
  strcpy((*dafed_dict)[8].keyarg,"0.0");
  strcpy((*dafed_dict)[8].error_mes,"a real number,angle in degree");
  (*dafed_dict)[8].key_type = 1;

  /*-----------------------------------------------------------------------*/
  /* 9)\bdry{} */
  strcpy((*dafed_dict)[9].keyword,"bdry");
  strcpy((*dafed_dict)[9].keyarg,"1");
  strcpy((*dafed_dict)[9].error_mes,"per or nonper");
  (*dafed_dict)[9].key_type = 1;
  /*-----------------------------------------------------------------------*/
  /* 10)\bin_num{} */
  strcpy((*dafed_dict)[10].keyword,"bin_num");
  strcpy((*dafed_dict)[10].keyarg,"10");
  strcpy((*dafed_dict)[10].error_mes,"numerical bin size");
  (*dafed_dict)[9].key_type = 1;
