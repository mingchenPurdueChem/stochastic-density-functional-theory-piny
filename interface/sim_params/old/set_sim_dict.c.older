...
/*------------------------------------------------------------------------*/ 
  /*  1)\cp_vxc_typ{pz_lda,pw_lda,pz_lsda}                                 */
        strcpy((*dict)[1].error_mes,"pz_lda,pw_lda,pz_lsda");
        strcpy((*dict)[1].keyword,"cp_vxc_typ");
        strcpy((*dict)[1].keyarg,"pz_lda");
 /*-----------------------------------------------------------------------*/ 
 /*  2)\cp_ggax_typ{becke,pw91x,fila_1x,fil_2x,pbe_x,brx89,brx2k,debug97x,off}*/
        strcpy((*dict)[2].error_mes,
        "becke,pw91x,fila_1x,fila_2x,brx89,brx2k,pbe_x:consistent with gga_lda/gga_lsda opt");
        strcpy((*dict)[2].keyword,"cp_ggax_typ");
        strcpy((*dict)[2].keyarg,"off");
  /*-----------------------------------------------------------------------*/ 
  /*  3)\cp_ggac_typ{lyp,lypm1,pw91c,pbe_c,tau1_c,off}                     */
        strcpy((*dict)[3].error_mes,
        "lyp,lypm1,pw91c,pbe_c,tau1_c:consistent with gga_lda/gga_lsda opt");
...
/*------------------------------------------------------------------------*/ 
  ...
  /*-----------------------------------------------------------------------*/ 
  /* 26)\hess_opt{full,diag,unit} */
        strcpy((*dict)[26].error_mes,"full,diag,unit ");
