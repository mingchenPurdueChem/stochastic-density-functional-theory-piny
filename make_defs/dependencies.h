...
---------------------------------------
control_group_communicators_dvr.o     : \
                         $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CP) $(TYP_CLASS) $(TYP_BND) \
                         $(TYP_PAR) $(COMM_ENT) $(COMM_WRAP) $(COMM_LOC) \
---------------------------------------
...
cp_energy_eext_dvr.o  :  $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_BND) $(TYP_CP) \
                         $(ENR_CP_ENT) $(ENR_CP_LOC) $(ENR_CPCON_LOC) \
                         $(FRND_ENT) $(MATH) $(COMM_WRAP) $(ENR_CTRL_ENT) \
---------------------------------------
...
xc_functionals_dvr.o  :  $(STANDARD) $(DEFINES) \
                         $(TYP_CLASS) $(TYP_GEN) $(TYP_CP) \
                         $(ENR_CP_LOC) $(MATH) $(COMM_WRAP) $(ENR_CPCON_LOC) \
---------------------------------------
...
cpcon_utils.o     :      $(STANDARD) $(DEFINES) \
                         ...
                         $(ENR_CPCON_LOC) $(FRND_ENT) $(MATH) $(COMM_WRAP) \
---------------------------------------
cpcon_utils_dvr.o    :   $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CP) \
                         $(ENR_CPCON_LOC) $(FRND_ENT) $(MATH) $(COMM_WRAP) \
---------------------------------------
...
min_CG_cp_dvr.o     :    $(STANDARD) $(DEFINES) \
                         ...
                         $(ENR_CTRL_LOC) $(ENR_CP_LOC) $(FRND_ENT) $(COMM_WRAP) \
...
parse.o     :            $(STANDARD) $(DEFINES) \
                         ...
                         $(INT_CPMIN_ENT) \
---------------------------------------
set_dvr_grid.o  :       $(STANDARD) $(DEFINES) \
                        $(TYP_GEN) $(TYP_CP) $(TYP_CLASS) $(TYP_BND) \
                        $(TYP_PAR) $(PARSE_LOC) $(MATH) \
---------------------------------------
...
---------------------------------------
set_cpewald_dvr.o     :  $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_CP) \
                         $(CPEWALD_LOC) $(MATH) $(FRND_ENT) \
...
---------------------------------------
output_cp_dvr.o     :    $(STANDARD) $(DEFINES) \
                         $(TYP_CLASS) $(TYP_BND) $(TYP_GEN) $(TYP_CP) \
                         $(OUTPUT_CP_ENT) $(OUTPUT_CP_LOC) $(ENR_CPCON_ENT) \
                         $(FRND_ENT) $(MATH) $(OUTPUT_LOC) $(COMM_WRAP) \
---------------------------------------
