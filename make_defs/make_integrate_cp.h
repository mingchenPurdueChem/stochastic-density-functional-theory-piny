...
#------------------------------------------------------------------
int_NVT_cp_dafed.o :     $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_CP) $(TYP_BND) \
                         $(INT_CP_ENT) $(INT_CP_LOC) $(INT_MD_ENT) \
                         $(INT_MD_LOC)  $(ENR_CPCON_ENT) $(ENR_CTRL_CP_ENT) \
                         $(INTRA_CON_ENT) $(ENR_CTRL_ENT) $(COMM_WRAP) \
                         $(COORD_LOC) \
                         $(DAFED_ENT) \
                         $(CODE)/integrate/cp/int_NVT_cp_dafed.c
	$(ECHO) $@
	$(COBJ) $(CODE)/integrate/cp/int_NVT_cp_dafed.c
...
#------------------------------------------------------------------
int_utils_cp_dvr.o    :  $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CP) $(TYP_CLASS) $(TYP_BND) \
                         $(INT_CP_LOC) $(COMM_WRAP) \
                         $(CODE)/integrate/cp/int_utils_cp_dvr.c
	$(ECHO) $@
	$(COBJ) $(CODE)/integrate/cp/int_utils_cp_dvr.c
...
#------------------------------------------------------------------
min_STD_cp_dvr.o     :   $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_BND) $(TYP_CP) \
                         $(INT_CPMIN_ENT) $(INT_CPMIN_LOC) $(ENR_CPCON_ENT) \
                         $(INTRA_CON_ENT) $(ENR_CTRL_CP_ENT) $(ENR_CP_ENT) \
                         $(ENR_CP_LOC) $(COMM_WRAP) \
                         $(CODE)/integrate/cpmin/min_STD_cp_dvr.c
	$(ECHO) $@
	$(COBJ) $(CODE)/integrate/cpmin/min_STD_cp_dvr.c
...
#------------------------------------------------------------------
min_CG_cp_dvr.o     :    $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_BND) $(TYP_CP) \
                         $(INT_CPMIN_ENT) $(INT_CPMIN_LOC) $(ENR_CPCON_ENT) \
                         $(ENR_CPCON_LOC) $(INTRA_CON_ENT) $(ENR_CTRL_CP_ENT) \
                         $(ENR_CTRL_LOC) $(ENR_CP_LOC) $(FRND_ENT) $(COMM_WRAP) $(MATH) \
                         $(CODE)/integrate/cpmin/min_CG_cp_dvr.c
	$(ECHO) $@
	$(COBJ) $(CODE)/integrate/cpmin/min_CG_cp_dvr.c
...
#------------------------------------------------------------------
move_atm_dvr.o     :     $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_BND) $(TYP_CP) \
                         $(INT_CPMIN_ENT) $(INT_CPMIN_LOC) $(ENR_CPCON_ENT) \
                         $(INTRA_CON_ENT) $(ENR_CTRL_CP_ENT) $(FRND_ENT) \
                         $(COMM_WRAP) $(MATH) \
                         $(CODE)/integrate/cpmin/move_atm_dvr.c
	$(ECHO) $@
	$(COBJ) $(CODE)/integrate/cpmin/move_atm_dvr.c
...
#------------------------------------------------------------------
shuffle_states_dvr.o :   $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_CP) $(TYP_BND) \
                         $(INT_CPMIN_ENT) $(INT_CPMIN_LOC) $(FRND_ENT) \
                         $(MATH) $(COMM_WRAP) $(ENR_CPCON_LOC) \
                         $(CODE)/integrate/cpmin/shuffle_states_dvr.c
	$(ECHO) $@
	$(COBJ) $(CODE)/integrate/cpmin/shuffle_states_dvr.c
...
#------------------------------------------------------------------
int_0_to_dt2_cp_dvr.o :  $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CP) $(TYP_CLASS) $(TYP_BND) \
                         $(INT_CP_ENT) $(INT_CP_LOC) $(INT_MD_LOC) \
                         $(ENR_CPCON_ENT) $(ENR_CTRL_CP_ENT) $(INTRA_CON_ENT) \
                         $(FRND_ENT) $(COMM_WRAP) $(COORD_LOC) \
                         $(CODE)/integrate/cp/int_0_to_dt2_cp_dvr.c
	$(ECHO) $@
	$(COBJ) $(CODE)/integrate/cp/int_0_to_dt2_cp_dvr.c
...
#------------------------------------------------------------------
int_dt2_to_dt_cp_dvr.o : $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CP) $(TYP_CLASS) $(TYP_BND) \
                         $(INT_CP_ENT) $(INT_CP_LOC) $(INT_MD_LOC) \
                         $(ENR_CPCON_ENT) $(ENR_CTRL_CP_ENT) \
                         $(INTRA_CON_ENT) $(FRND_ENT) $(COMM_WRAP) \
                         $(COORD_LOC) $(INT_CPPIMD_LOC) $(INT_PIMD_LOC) \
                         $(CODE)/integrate/cp/int_dt2_to_dt_cp_dvr.c
	$(ECHO) $@
	$(COBJ) $(CODE)/integrate/cp/int_dt2_to_dt_cp_dvr.c
