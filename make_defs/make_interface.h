...
#==================================================================
mall_scratch_dvr.o     : $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_BND) $(TYP_CP) \
                         $(SCRATCH_ENT) $(SCRATCH_LOC) $(FRND_ENT) \
                         $(COMM_WRAP) \
                         $(CODE)/interface/scratch/mall_scratch_dvr.c
	$(ECHO) $@
	$(COBJ_CARE) $(CODE)/interface/scratch/mall_scratch_dvr.c
...
set_dvr_grid.o     :     $(STANDARD) $(DEFINES) \
                         ...
                         $(TYP_CP) $(TYP_CLASS) \
                         $(PARSE_LOC) \
                         $(CODE)/interface/parse/set_dvr_grid.c
	$(ECHO) $@
	$(COBJ_CARE) $(CODE)/interface/parse/set_dvr_grid.c
