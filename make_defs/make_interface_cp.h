...
#------------------------------------------------------------------
read_coef_dvr.o   :      $(STANDARD) $(DEFINES) \
                         $(TYP_CLASS) $(TYP_PAR) $(TYP_GEN) $(TYP_CP) \
                         $(ENR_CPCON_ENT) $(COORD_CP_ENT) $(HANDLE_ENT) \
                         $(FRND_ENT) $(COMM_WRAP) \
                         $(CODE)/interface/coords_cp/read_coef_dvr.c
	$(ECHO) $@
	$(COBJ_CARE) $(CODE)/interface/coords_cp/read_coef_dvr.c
...
#------------------------------------------------------------------
gen_wave_dvr.o     :     $(STANDARD) $(DEFINES) $(TYP_GEN) \
                         $(TYP_CP) $(TYP_PAR) $(TYP_CLASS) $(TYP_BND) \
                         $(FRND_ENT) $(MATH) $(COMM_WRAP) $(ENR_CPCON_LOC) \
                         $(ENR_CP_LOC) $(CPEWALD_LOC) $(COORD_CP_LOC) \
                         $(HANDLE_ENT) $(ENR_CTRL_ENT) \
                         $(CODE)/interface/coords_cp/gen_wave_dvr.c
	$(ECHO) $@
	$(COBJ_CARE) $(CODE)/interface/coords_cp/gen_wave_dvr.c
...
control_set_cp_ewald_dvr.o : $(STANDARD) $(DEFINES) \
                             ...
                             $(CPEWALD_ENT) $(CPEWALD_LOC) $(ENR_CP_LOC) \
                             $(MATH) $(FRND_ENT) $(COMM_WRAP) \
                             $(CODE)/interface/cp_ewald/control_set_cp_ewald_dvr.c
	$(ECHO) $@
	$(COBJ_CARE) $(CODE)/interface/cp_ewald/control_set_cp_ewald_dvr.c
...
#------------------------------------------------------------------
set_cp_ewald_dvr.o     : $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CLASS) $(TYP_CP) \
                         $(CPEWALD_LOC) $(MATH) $(FRND_ENT) \
                         $(CODE)/interface/cp_ewald/set_cp_ewald_dvr.c
	$(ECHO) $@
	$(COBJ_CARE) $(CODE)/interface/cp_ewald/set_cp_ewald_dvr.c
...
#------------------------------------------------------------------
control_vps_params_dvr.o : $(STANDARD) $(DEFINES) \
                           $(TYP_GEN) $(TYP_CP) $(TYP_PAR) \
                           $(TYP_CLASS) $(TYP_BND) \
                           $(VPS_ENT) $(SEARCH_ENT) $(INTRA_LOC) $(VPS_LOC) \
                           $(HANDLE_ENT) $(FRND_ENT) $(COMM_WRAP) $(MATH) \
                           $(CODE)/interface/vps_params/control_vps_params_dvr.c
	$(ECHO) $@
...
#------------------------------------------------------------------
control_vc_smpl_dvr.o     :  $(STANDARD) $(DEFINES) \
                         $(TYP_GEN) $(TYP_CP) \
                         $(SMPL_CP_ENT) $(SMPL_CP_LOC) $(COMM_WRAP) \
                         $(CODE)/interface/vel_sampl_cp/control_vc_smpl_dvr.c
	$(ECHO) $@
	$(COBJ_CARE) $(CODE)/interface/vel_sampl_cp/control_vc_smpl_dvr.c
