...
#------------------------------------------------------------------
math_rs_mkl.o       :   $(DEFINES) $(STANDARD) $(MATH) \
                         $(CODE)/mathlib/math_rs_mkl.f
	$(ECHO) $@
	$(FOBJ) $(CODE)/mathlib/math_rs_mkl.f

#------------------------------------------------------------------
gaussq.o       :   $(DEFINES) $(STANDARD) $(MATH) \
                        $(CODE)/mathlib/gaussq.f
	$(ECHO) $@
	$(FOBJ) $(CODE)/mathlib/gaussq.f
...
lbfgs.o       :   $(DEFINES) $(STANDARD) $(MATH) \
                        $(CODE)/mathlib/lbfgs.f
	$(ECHO) $@
	$(FOBJ) $(CODE)/mathlib/lbfgs.f

#------------------------------------------------------------------
lpck.o       :   $(DEFINES) $(STANDARD) $(MATH) \
                        $(CODE)/mathlib/lpck.f
	$(ECHO) $@
	$(FOBJ) $(CODE)/mathlib/lpck.f
