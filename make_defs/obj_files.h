...
CP_ENERGY_FILES       = test_energy_cp.o test_energy_cp_dvr.o\
                        cp_energy_control.o cp_wannier_control.o \
                        cp_ks_energy.o cp_ks_energy_dvr.o cp_energy_ee_rho.o \
			cp_energy_ee_rho_threads_state.o \
                        cp_energy_ee_rho_dvr.o cp_energy_ee_rho_ke.o \
                        cp_energy_ee_grad_rho.o cp_energy_eext.o cp_energy_eext_dvr.o \
                        cp_energy_eext_nonloc.o cp_energy_eext_nonloc_gh.o \
			cp_energy_eext_nonloc_real.o cp_energy_eext_nonloc_real_threads.o \
			...
			cp_energy_eext_nonloc_real_force_threads.o \
                        ...
                        cp_orth_rot_utils_dvr.o cp_con_utils.o cp_con_utils_dvr.o \
                        energy_control_elec.o orth_rot_control_cp.o cp_transpose.o \
                        orth_rot_control_cp_dvr.o cp_transpose_dvr.o \
                        control_contract_rho.o control_spread_rho.o \
                        calcul_dipole.o  calcul_wannier.o calcul_wannier_dvr.o \
                        utils_wannier.o 
...
INTEGRATE_CP_FILES    = int_NVE_cp.o int_NVT_cp.o int_NPTI_cp.o int_NPTF_cp.o int_NVT_cp_dafed.o \
                        min_STD_cp.o min_STD_cp_dvr.o min_CG_cp.o min_CG_cp_dvr.o \
                        min_DIIS_cp.o move_atm.o move_atm_dvr.o \
                        int_utils_cp.o int_0_to_dt2_cp.o int_0_to_dt2_cp_dvr.o \
                        int_dt2_to_dt_cp.o int_dt2_to_dt_cp_dvr.o \
                        shuffle_states.o cp_gauss.o int_utils_cp_dvr.o shuffle_states_dvr.o
...
INTEGRATE_MD_FILES    = int_NVE.o int_NVE_res.o int_NVT.o int_NVT_res.o int_NVT_res_dafed.o \
...
INTERFACE_FILES       = parse.o zero_class.o zero_bnd.o zero_par.o zero_cp.o \
	                ...
	                block_intra_lists.o control_scale_class.o \
                        ...
                        set_dvr_grid.o mall_scratch_dvr.o
...
INTERFACE_MOL_FILES   = control_mol_params.o control_set_mol_params.o \
                        ...
                        set_surf_params.o set_dafed_params.o 
...
MAIN_CP_FILES         = control_cp.o control_cp_min.o control_debug_cp.o \
                        ...
                        control_cp_pimd_min.o control_dvr.o 
MATH_FILES            = mathlib.o blas_wrappers.o fft_package.o \
                        fft_create_package.o fft_generic.o gaussq.o lbfgs.o lpck.o
...
OUTPUT_CP_FILES       = output_cp.o output_cp_min.o output_min.o simpavg_cp.o \
                        output_cp_dvr.o simpavg_cp_communicate.o simpavg_cp_pimd.o \
                        output_cp_pimd.o 
COMMUNICATE_FILES     = communicate_wrappers.o \
                        ...
                        control_group_communicators.o control_group_communicators_dvr.o
...
STODFT_FILES	      = coeff.o control-stodft.o filters.o init.o \
			...
			energy-wrapper-post-scf.o energy-wrapper-scf.o checkpointIO.o \
                        cp-energy-eext-fric.o calc-friction.o rational-apprx.o
FRAG_FILES	      = frag-scf.o init-frag.o parse-frag.o copy-input.o \
			...
			frag-nlmat-real.o ke-cor-uc.o control-fd-frag.o
...
OBJS_CARE = make_lnk_lst.o make_lnk_map.o lnk_lst_dis.o parse.o \
            ...
            set_wave_params.o set_coef_NHC.o read_coef.o read_coef_dvr.o mall_coef.o \
            control_set_cp_ewald.o set_recip.o search_base_cp.o \
            set_cp.o proj_vel_cp.o set_vps_dict.o samp_vel_cp.o \
            control_vps_params.o control_vc_smpl.o control_vc_smpl_dvr.o control_vcnhc_smpl.o \
            ...
            output_cp_min.o mall_scratch_dvr.o control_vps_params_dvr.o \
            control_set_cp_ewald_dvr.o
