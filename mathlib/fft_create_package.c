...
void para_fft_gen3d_init_dvr(PARA_FFT_PKG3D *para_fft_pkg3d)
...
#ifdef FFTW3
  int nfft_size=2*nkf_a*nkf_b*nkf_c;//Length is 2*nkf_a*nkf_b*nkf_c
 //int nfft_size=para_fft_pkg3d->nfft_size;
#endif 
...
#ifdef FFTW3
  if(igeneric_opt==0) {
    iopt=1;//It is backward FFT for fftw3.
    para_fft_pkg3d->plan_fftw_ba = fftw_plan_many_dft(1,&nkf_a,num,
          dummy,NULL,incl,incn,dummy,NULL,incl,incn,iopt,FFTW_MEASURE);
  } else {
    fft_gen1d_init(nkf_a,incl,num,incn,iopt,&ier,
