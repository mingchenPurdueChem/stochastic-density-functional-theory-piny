...
void write_dump_coef_cp_dvr(FILE *,CP *,CLASS *,int );
void write_dump_vcoef_cp(FILE *,CP *,CLASS *,GENERAL_DATA *,int );
void write_dump_vcoef_cp_dvr(FILE *,CP *,CLASS *, GENERAL_DATA *,int );
...
void write_dipole_file_cp(GENERAL_DATA *,CP *);
void write_wan_cent_file_cp(GENERAL_DATA *,CP *);
