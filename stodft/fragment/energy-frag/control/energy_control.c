...
/* VI) Finish energy routine                                            */
  ...
  energy_control_dafed(class,bonded,general_data);

/*======================================================================*/
/* VII) Finish energy routine                                            */
...
void energy_control_only_dafed(CLASS *class, BONDED *bonded,
                    GENERAL_DATA *general_data)
...
/*======================================================================*/
  ...
  if(myid==0) energy_control_dafed(class,bonded,general_data); // IC
