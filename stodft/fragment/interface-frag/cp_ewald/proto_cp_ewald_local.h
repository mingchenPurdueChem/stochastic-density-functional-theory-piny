...
void calc_kmaxv(int *, int *, int *, int *, int *, double *, double , double, int);


void setkvec3d_all(int ,int *,double *, int *, int *, int *, int *, int *,
                   double *, double *);

void set_cpmass_dvr(CPCOEFFS_INFO *, double *, int *);
