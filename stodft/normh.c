...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcHelpVariables(CLASS *class,GENERAL_DATA *general_data,
                 CP *cp,CPCOEFFS_POS  *cpcoeffs_pos,CLATOMS_POS *clatoms_pos)
/*==========================================================================*/
/*         Begin Routine                                                    */
   {/*Begin Routine*/
/*************************************************************************/
/* A lot of variables are only calculated at the first step of SCF loop  */
/* We calculate all of them so that they are not evaluated during SCF    */
/*************************************************************************/
/*=======================================================================*/
/*         Local Variable declarations                                   */
...
/*======================================================================*/
/* IV) If break point number one or you are just starting out calculate */
/*     the helpful vectors                                              */
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcKSPotExtRecipWrap(CLASS *class,GENERAL_DATA *general_data,
		 CP *cp,CPCOEFFS_POS  *cpcoeffs_pos,CLATOMS_POS *clatoms_pos)
/*==========================================================================*/
/*         Begin Routine                                                    */
   {/*Begin Routine*/
/*************************************************************************/
/* This is the wrapper to calculate Kohn-Sham potential after density    */
/* calculation. This routine comes from control_cp_eext_recip and        */
/* calculate the reciprocal space of external potential vext	         */
/*************************************************************************/
/*=======================================================================*/
/*         Local Variable declarations                                   */
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcCoefForceExtRecipWrap(CLASS *class,GENERAL_DATA *general_data,
                 CP *cp,CPCOEFFS_POS *cpcoeffs_pos,CLATOMS_POS *clatoms_pos)
/*==========================================================================*/
/*         Begin Routine                                                    */
   {/*Begin Routine*/
