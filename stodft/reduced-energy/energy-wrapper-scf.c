...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcLocalPseudoScf(CLASS *class,GENERAL_DATA *general_data,
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcNonLocalPseudoScf(CLASS *class,GENERAL_DATA *general_data,
                 CP *cp,CPCOEFFS_POS *cpcoeffs_pos,CLATOMS_POS *clatoms_pos)
/*==========================================================================*/
/*         Begin Routine                                                    */
   {/*Begin Routine*/
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcKSPot(CLASS *class,GENERAL_DATA *general_data,
                   CP *cp,CPCOEFFS_POS  *cpcoeffs_pos,CLATOMS_POS *clatoms_pos)
/*==========================================================================*/
/*         Begin Routine                                                    */
   {/*Begin Routine*/
...
/* II) get the ks potential                                                 */
  ...
  printf("v_ks_up %lg %lg %lg\n",v_ks_up[1],v_ks_up[10],v_ks_up[100]);
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcCoefForceScf(CLASS *class,GENERAL_DATA *general_data,
                   CP *cp,CPCOEFFS_POS  *cpcoeffs_pos,CLATOMS_POS *clatoms_pos)
/*==========================================================================*/
/*         Begin Routine                                                    */
   {/*Begin Routine*/
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcCoefForceWrapSCF(CLASS *class,GENERAL_DATA *general_data,
                   CP *cp,CPCOEFFS_POS  *cpcoeffs_pos,CLATOMS_POS *clatoms_pos)
/*==========================================================================*/
/*         Begin Routine                                                    */
   {/*Begin Routine*/
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcCoefForceWrapSCFReal_g(CLASS *class,GENERAL_DATA *general_data,
                   CP *cp,CPCOEFFS_POS  *cpcoeffs_pos,CLATOMS_POS *clatoms_pos,
...
/* 1) Calculate the H/sigma|phi> */
  ...
  //cputime(&time_st);
  calcCoefForceScfReal_g(class,general_data,cp,cpcoeffs_pos,clatoms_pos,
                         creRev2, cimRev2, creImv2, cimImv2,
                         creRev12, cimRev12, creImv12, cimImv12,
                         spinFlag);
  //cputime(&time_end);
  //stodftInfo->cputime2 += time_end-time_st;
...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void calcCoefForceScfReal_g(CLASS *class,GENERAL_DATA *general_data,
                   CP *cp,CPCOEFFS_POS  *cpcoeffs_pos,CLATOMS_POS *clatoms_pos,
                   double *creRev2, double *cimRev2, double *creImv2, double *cimImv2,
                   double *creRev12, double *cimRev12, double *creImv12, double *cimImv12,
                   int spinFlag)
...
/*-------------------------------------------------------------------------*/
 ...
 /* i)  Up states                           */
  if(spinFlag==0){
    coefForceCalcHybridSCFRationalG(cpewald,nstate_up,creal_up,cimag_up,
			  fcreal_up,fcimag_up,
			  zfft,zfft_tmp,v_ks_up,v_ks_tau_up,ak2_sm,&cp_eke,pvten_cp,
			  cp_ptens_calc,hmati_cp,communicate,icoef_form_up,
			  icoef_orth_up,ifcoef_form_up,cp_tau_functional,cp_min_on,
 ...
 /* ii) down states (if necessary)             */
  ...
  if(spinFlag==1){
    coefForceCalcHybridSCFRationalG(cpewald,nstate_dn,creal_dn,cimag_dn,
                          fcreal_dn,fcimag_dn,
                          zfft,zfft_tmp,v_ks_dn,v_ks_tau_dn,ak2_sm,&cp_eke_dn,pvten_cp,
                          cp_ptens_calc,hmati_cp,communicate,icoef_form_dn,
                          icoef_orth_dn,ifcoef_form_dn,cp_tau_functional,cp_min_on,
